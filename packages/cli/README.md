...
running command...
$ atws (--version)
@atws/cli/1.1.4 win32-x64 node-v18.15.0
$ atws --help [COMMAND]
USAGE
  $ atws COMMAND
...
...
_See code: [dist/commands/init/index.ts](https://github.com/Austrian-Web-Services/config/blob/v1.1.4/dist/commands/init/index.ts)_
<!-- commandsstop -->
